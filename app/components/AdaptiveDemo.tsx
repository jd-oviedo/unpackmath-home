...
import { Button, Frame, Fraction } from "./ui";
import { stats } from "../../lib/stats";

/**
 * The three-question adaptive demo, standalone.
 *
 * Extracted from LiveDemo so /for-students can carry the real quiz in its hero.
 * That page's visitor IS the person who takes the test, which is the argument
 * against putting it on /for-teachers and for putting it here.
 *
 * Everything below moved verbatim: the questions, the level logic, the engine
 * panel and its styles. LiveDemo keeps only the section chrome, so the homepage
 * renders byte-identical markup to before the split.
 */
